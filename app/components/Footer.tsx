      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <Link href="https://www.instagram.com/cherry.lips_show.bar_?igsh=cjF2MGczcGZ0aG5v&utm_source=qr" target="_blank" className="text-white hover:text-red-500 transition-colors">
